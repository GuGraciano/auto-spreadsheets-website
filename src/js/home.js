document.addEventListener("DOMContentLoaded", async function () {
  ...
  if (!userString) {
    ...
    userAccountContainer.innerHTML = `
            <img src="https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/blogs/2147503633/images/22af86c-42bc-03d2-6141-0b8b1fb4b60_AdobeStock_104938952.jpeg" alt="Perfil" class="profile-img">
            <a href="login.html">Valdemir</a>
        `;
    return;
  }
